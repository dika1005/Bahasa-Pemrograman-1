...
public class dataNilai extends javax.swing.JFrame {
    ...
    private void load_data() {
        Object header[] = { "Nilai", "Matkul", "Grade", "SKS"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        jTable1.setModel(data);
        String sql = "SELECT Nilai, Matkul, Grade, SKS FROM nilai";
    ...
    public void input_data() {
        try {
            String sql = "INSERT INTO nilai values('" + jTextField1.getText()
                    + "','" + jTextField2.getText()
                    + "','" + jTextField3.getText()
                    + "','" + jTextField4.getText()
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try{
            String sql_edit = "UPDATE nilai SET Matkul = '"+jTextField2.getText()
                    + "', Grade = '" + jTextField3.getText()
                    + "', SKS = '" + jTextField4.getText()
                    + "' WHERE Nilai = '" + jTextField1.getText()
                    + "'";
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        // TODO add your handling code here:
         try {
            st = Koneksi.con.createStatement();
            String sql_delete = "DELETE FROM nilai WHERE Nilai = '"+jTextField1.getText()+"'";
