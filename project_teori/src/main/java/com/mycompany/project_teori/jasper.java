...
public class jasper {
    ...
    public void generateReport(List<Map<String, ?>> data) {
        try {
            ...
            titleText.setText("Laporan Suara Hasil Pemilihan");
            titleText.setX(0);
            titleText.setY(10);
            ...
            String[] headers = { "paslon1", "paslon2" };
    ...
    List<Map<String, ?>> fetchData() {
        ...
        try (Connection con = koneksi.getConnection();
            ...
            while (rs.next()) {
                ...
                row.put("paslon1", rs.getString("paslon1"));
                row.put("paslon2", rs.getString("paslon2"));
                data.add(row);
            }
        } catch (Exception e) {
            e.printStackTrace();
